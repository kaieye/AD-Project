...
def main(raw_folder, root_folder, mode_flag, step_7_f, step_7_g):
    ...
    if mode_flag == 'images': # if mode_flag is "images", run until all processed cases are saved in the images folder
        ...
        print(r'There are {} good cases already processed'.format(len(good_dict)))
        # print(image_dict,"\n")
        # print(raw_dict,"\n")
        # print(good_dict,"\n")
    ...
    filename_pass = ["NACC137580","NACC493067","NACC506549","NACC511568","NACC524845","NACC548291","NACC578550","NACC591634","NACC615843","NACC620086","NACC622614","NACC626755","NACC630500","NACC632364","NACC641044","NACC647342","NACC662385","NACC682539","NACC695146","NACC711330","NACC711731","NACC714835","NACC725343","NACC737311","NACC744382","NACC761791","NACC777183","NACC780482","NACC812188","NACC981216"]
    listdir = os.listdir('/gemini/code/NACC_processed_nii/images_past/')
    for i in range(len(listdir)):
        listdir[i] = listdir[i][:10]
    for key in file_dict:
        path_name = file_dict[key]
        path = os.path.dirname(path_name)
        name = path_name.split('/')[-1] 
        
        if name[:10] in listdir:
