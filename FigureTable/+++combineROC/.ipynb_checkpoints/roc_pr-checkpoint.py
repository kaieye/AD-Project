...
if __name__ == "__main__":
    # NACC
    mri_csv_files = ['/root/autodl-tmp/ncomms2022-main/tb_log/CNN_baseline_new_cross{}/test_eval.csv'.format(i) for i in range(5)]
    nonImg_csv_files = ['/root/autodl-tmp/ncomms2022-main/tb_log/SupportVector_CrossValid_nonImg_cross{}/test_eval.csv'.format(i) for i in range(5)]
    # fusion_csv_files = ['/root/autodl-tmp/ncomms2022-main/tb_log/Fusion_SVM_CNN_cross{}/test_mri_eval.csv'.format(i) for i in range(5)]
    fusion_csv_files = ['/root/autodl-tmp/ncomms2022-main/tb_log/XGBoost_CrossValid_nonImg_cross{}/test_eval.csv'.format(i) for i in range(5)]
